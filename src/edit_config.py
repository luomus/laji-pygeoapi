...
def add_to_pygeoapi_config(template_resource, template_params, pygeoapi_config_path):
    """
    ...
    pygeoapi_config (str): The path to the output pygeoapi configuration file.
    """
    ...
    with open(pygeoapi_config_path, "a") as file:
        file.write(template)

def add_metadata_to_config(pygeoapi_config_path, db_path_in_config):
    """
    ...
    with open(pygeoapi_config_path, "a") as file:
        ...
        print(f"metadata ({db_path_in_config}) added to config file {pygeoapi_config_path}")
