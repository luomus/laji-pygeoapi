...
@patch("edit_configmaps.get_kubernetes_info", return_value=("https://kube.api", "default"))
@patch("edit_configmaps.update_configmap")
@patch("edit_configmaps.delete_pod")
