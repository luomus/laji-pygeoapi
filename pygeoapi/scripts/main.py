...
def load_files(config):
        # Load essential data
        municipals_gdf = gpd.read_file('pygeoapi/scripts/municipalities.geojson', engine='pyogrio')
...
def main():
    ...
    edit_metadata.create_metadata("pygeoapi/scripts/template_resource.txt", config["metadata_db_path"], config["pygeoapi_config_out"])
